...
Berdasarkan analisis sensitivitas OAT (20 replikasi per parameter), **urutan prioritas faktor kebijakan berdasarkan besaran dampak terhadap IPK rata-rata adalah: umpan balik (+0,75) > ukuran kelas (+0,68) > mode perkuliahan (+0,39) > efektivitas pengajaran (+0,38) > suhu ruangan (+0,32) > beban tugas (+0,25)**. Implikasi langsungnya: program studi yang ingin meningkatkan kinerja mahasiswa sebaiknya memprioritaskan kebijakan pengembalian nilai yang cepat — faktor dengan dampak terbesar dan biaya implementasi yang relatif rendah — sebelum mempertimbangkan perubahan ukuran kelas yang membutuhkan investasi lebih besar.

**RQ3 — Efektivitas program tutoring:**
Program tutoring selama 4 minggu (minggu 7–10) yang ditargetkan kepada 25% mahasiswa berkinerja terendah berhasil meningkatkan IPK rata-rata kuartil terbawah secara terukur. Terdapat efek *momentum* pasca-program: peningkatan berlanjut meskipun intervensi telah berakhir. Intervensi yang ditargetkan lebih efisien daripada perubahan kebijakan yang berlaku untuk seluruh kelas. Namun, ketika diuji pada kondisi skenario terburuk (60 mahasiswa, beban berat, umpan balik lambat), efek tutoring menjadi jauh lebih terbatas (IPK +0,05, kegagalan turun dari 90% ke 85%), mengimplikasikan bahwa intervensi tutoring paling efektif bila dikombinasikan dengan perbaikan kondisi lingkungan belajar.
...
**Kesimpulan umum:**
Simulasi berbasis agen mampu menangkap pola kualitatif dinamika kelas yang konsisten dengan literatur psikologi pendidikan. Kontribusi utama penelitian ini bukan terletak pada penemuan hubungan baru antara variabel pendidikan — hal tersebut sudah banyak didokumentasikan oleh penelitian empiris — melainkan pada **artefak komputasional** yang dihasilkan: prototipe ClassTwin yang bersifat *open-source*, sepenuhnya dapat direproduksi melalui *random seed* tetap dan konfigurasi JSON terserialisasi, serta dilengkapi antarmuka *dashboard* Streamlit untuk pengguna non-teknis. Nilai praktis artefak ini terletak pada kemampuannya untuk melakukan perbandingan skenario kebijakan secara virtual sebelum diterapkan di kelas nyata, menangkap efek interaksi non-linear antar faktor kebijakan (seperti skenario kasus terburuk), dan menyediakan kuantifikasi relatif antar faktor kebijakan melalui analisis sensitivitas OAT — yang kesemuanya tidak tersedia dari tinjauan literatur konvensional.
